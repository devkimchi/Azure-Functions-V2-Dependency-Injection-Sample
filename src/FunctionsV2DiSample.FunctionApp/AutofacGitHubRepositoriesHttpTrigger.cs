...
//        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = "autofac/repositories")]HttpRequest req, TraceWriter log)
//        {
//            var options = GetOptions(req);

//            var result = await Factory.Create<IFunction>(log, "github").InvokeAsync<HttpRequest, object>(req, options).ConfigureAwait(false);
